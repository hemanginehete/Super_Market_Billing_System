...
public Forget()
{
	...
	setVisible(true);
	//new buyer label
	ImageIcon newblimg=new ImageIcon("forget.gif");
	...
	String genderstr[] = {"Your Nick Name?","Your Luck Number","Your Child Super Hero","Your ChildHood Name"};
	...
	add(buyercontactt);
	nbgender.setBounds(210,200,300,30);
	add(nbgender);
	...
	if(bName.equals("") || bContact_no.equals("") || bEmail.equals("")
	|| bAddress.equals(""))
	{
	...
	String sqls="Insert into account values('"+bName+"','"+bContact_no+"','"+bGender+"','"+bAddress+"','"+bEmail+"');";
